...
۳. بدون پیشوند یا علامت نقل‌قول پاسخ دهید.`;
    ...
    for (const modelName of candidateModels) {
      try {
        ...
        if (
          ...
          console.warn(`[Gemini AI Failover] Model ${modelName} temporarily busy (503/429). Seamlessly switching to next model...`);
  ...
  if (
    lowerMsg.includes('سلام') ||
    lowerMsg.includes('درود') ||
  ...
  if (
    ...
    lowerMsg.includes('asl') ||
    lowerMsg.includes('اسمت') ||
  ...
  const fallbacks = [
    'مرسی عزیزم منم خوبم، چیکارا میکنی؟',
    'آره دقیقا، دیگه چه خبرا؟ برام بگو',
    'منم پای گوشی بودم داشتم چت میکردم، روزت چطور بود؟',
    'چه جالب، خوشحالم باهات همصحبت شدم',
  ];
  return {
